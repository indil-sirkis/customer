...
class S {
  ...
  String get search_for_markets_or_products {
    return Intl.message(
      ...
      name: 'search_for_stores_or_products',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Your order has been successfully submitted!`
  String get your_order_has_been_pending {
    return Intl.message(
      'Your order has been pending',
      name: 'your_order_has_been_pending',
      desc: '',
      args: [],
    );
  }
  String get your_order_has_been_failed {
    return Intl.message(
      'Your order has been failed',
      name: 'your_order_has_been_failed',
      desc: '',
      args: [],
    );
  }
  ...
  String get payment_options_close {
    return Intl.message(
      'Currently not accepting card payment',
      name: 'payment_options_close',
      desc: '',
      args: [],
    );
  }
  ...
  String get dont_have_any_item_in_your_cart {
    return Intl.message(
      ...
      name: 'don\'t_have_any_item_in_your_cart',
      desc: '',
      args: [],
    );
  }
  ...
  String get select_mode_of_delivery {
    return Intl.message(
      'Select mode of delivery',
      name: 'select_mode_of_delivery',
      desc: '',
      args: [],
    );
  }
  ...
  String get pickup_your_product_from_the_market {
    return Intl.message(
      ...
      name: 'pickup_your_product_from_the_store',
      desc: '',
      args: [],
    );
  }
  ...
  String get pay_with_apple_pay {
    return Intl.message(
      'Pay with Apple Pay',
      name: 'pay_with_apple_pay',
      desc: '',
      args: [],
    );
  }

  String get click_to_pay_online {
    return Intl.message(
      'Click to pay online',
      name: 'click_to_pay_online',
      desc: '',
      args: [],
    );
  }
  ...
  String get tap_to_pay_cash_on_delivery {
    return Intl.message(
      'Tap to pay cash on delivery',
      name: 'tap_to_pay_cash_on_delivery',
      desc: '',
      args: [],
    );
  }
