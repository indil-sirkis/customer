...
class _CartItemWidgetState extends State<CartItemWidget> {
  ...
  void initState() {
    ...
    super.initState();
    cartPrice = widget.cart.product.price;
    widget.cart.options.forEach((element) {
                          ...
                          onPressed: () {
                            if (widget.cart.product.active) {
                              ...
                              Fluttertoast.showToast(
                                  msg: "This Product not available");
                            }
                          },
                          iconSize: 30,
