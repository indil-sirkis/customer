  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      onDismissed: (direction) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("The conversation with ${widget.message.name} is dismissed")));
      },
      child: InkWell(
        onTap: () {
                  ...
                  children: <Widget>[
                    Row(
                      children: [
                        ...
                        Text(
                          DateFormat('hh:mm a').format(DateTime.fromMillisecondsSinceEpoch(this.widget.message.lastMessageTime, isUtc: false)),
                          overflow: TextOverflow.fade,
                          softWrap: false,
