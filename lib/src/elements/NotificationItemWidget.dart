          ...
          children: <Widget>[
            Stack(
              children: <Widget>[
                Container(
                  ...
                  child:Padding(padding: EdgeInsets.all(15),child: Image.asset("assets/img/notifications.png",color: Theme.of(context).scaffoldBackgroundColor,height: 25,width: 25)),
                ),
                Positioned(
                  right: -30,
                  bottom: -50,
            ...
            Flexible(
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    Helper.of(context).trans(notification.notifiable_type,notification.type),
