...
class _MarketWidgetState extends StateMVC<MarketWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if(_con.market != null) {
      print("LEN:::${_con.market
          .timing
          .length}");
      var day = DateFormat('EEEE').format(DateTime.now());
      for (int i = 0; i < _con.market
          .timing
          .length; i++) {
        Timing timing = _con.market
            .timing[i];
        if (timing.day == day) {
                                                ...
                                                Navigator.of(context).pushNamed('/Chat',
                                                    arguments: RouteArgument(
                                                        param: new Conversation(
                                                            ...
                                                            id: "${currentUser.value.id}-${_con.market.id}")));
                                              }
                                            : null,
                                        child: Icon(
                                          Icons.chat_outlined,
                                  ...
                                  children: <Widget>[
                                    ...
                                    SizedBox(
                                      ...
                                      child: MaterialButton(
                                        ...
                                        padding: EdgeInsets.all(0),
                                        onPressed: () {
                                          launch("tel:${_con.market.mobile != null ? _con.market.mobile:_con.market.phone}");
                                        },
