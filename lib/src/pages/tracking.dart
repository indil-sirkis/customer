              ...
              : Column(
                  ...
                  children: <Widget>[
                    ...
                    MaterialButton(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: Helper.getStarsList(double.parse(_con.order.productOrders.length > 0 ?_con.order.productOrders[0].product.market.rate:"0"), size: 35),
                      ),
                    ),
                  ],
                ),
