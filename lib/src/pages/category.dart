...
import 'package:markets/src/elements/EmptyCategoryWidget.dart';
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          _con.loadCart
              ...
              : ShoppingCartButtonWidget(iconColor: Theme.of(context).primaryColor, labelColor: Theme.of(context).primaryColor),
        ],
      ),
